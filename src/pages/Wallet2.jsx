        ...
        <div className="w-full">
            ...
            <div className="p-14 min-h-screen">
                ...
                <div className="bg-pink-400 rounded-lg w-full px-20 py-20 text-white shadow-lg relative overflow-hidden text-center">
                    <div className="absolute right-0 top-0 w-24 h-24 bg-pink-200 rounded-full transform translate-x-8 -translate-y-8"></div>
                    <h3 className="text-xl font-medium mb-2">Total Money</h3>
                    <p className="text-3xl font-bold mb-6">$500</p> {/* Thay giá trị động nếu có */}

                    {/* Nút Nạp tiền & Rút tiền */}
                    <div className="flex justify-center gap-6">
                        <button className="bg-white text-pink-500 font-bold px-6 py-3 rounded-full shadow-md hover:bg-pink-300 hover:text-white transition">
                            + Nạp Tiền
                        </button>
                        <button className="bg-white text-pink-500 font-bold px-6 py-3 rounded-full shadow-md hover:bg-pink-300 hover:text-white transition">
                            - Rút Tiền
